...
namespace CourseLibrary.API.Migrations
{
    ...
    [Migration("20200906172351_InitialMigration")]
            ...
            modelBuilder.Entity("CourseLibrary.API.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1969, 8, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -5, 0, 0, 0)),
                            FirstName = "Huxford",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1972, 1, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Dwennon",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1982, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -5, 0, 0, 0)),
                            FirstName = "Rushford",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1976, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -5, 0, 0, 0)),
                            FirstName = "Hagley",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1977, 2, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            FirstName = "Mabel",
